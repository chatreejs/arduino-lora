...
```
- ??????????????????????????????????????????????? ????????????????????????????????
    - `frequency` ??? ?????????????????????????????????????? Hz (`433E6`, `866E6`, `915E6`)
    - ??????????????????????????? 433MHz ???????????????? 433E6
...
```
   - ???????????????????????????????????????????????? packet
   - `implicitHeader` - (optional) `true` ?????????? implicit mode, `false` ????????? implicit mode (???????????)
Return `1` ???????????????????????, `0` ???????????????????????????????????
...
```
   - ???????????????????????????????????? packet ???? ?????????????????
   - `async` - (optional) `true` ?????????? non-blocking mode, `false` ????????????????????????? (???????????)
Return `1` ???????????, `0` ???????????????????
...
```
   - `size` - (optional) ??? `> 0` implicit header mode is enabled with the expected a packet of size bytes, default mode is explicit header mode
Return ??????? packet ???? bytes ???? `0` ???????? packet ??????
